    ...
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="grid md:grid-cols-2  gap-6 max-w-4xl mx-auto">
        {verificationTypes.map((type) => (
          ...
          >
            <button
              className="p-6 disabled:text-black/50 disabled:shadow-none disabled:cursor-not-allowed shadow-md rounded-md cursor-pointer h-full hover:shadow-lg transition-shadow"
              onClick={() =>
